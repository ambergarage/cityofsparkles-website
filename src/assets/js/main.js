...
import 'modules/jquery.viewport';
...
import WOW from 'exports-loader?this.WOW!wowjs';
...
(function($){
    ...
    function init_ajaxchimp(){

        var mailchimpCallback = function (resp) {
...
function initPageSliders(){
    (function($){
        ...
        $(".slider-btn").click(
          function (e) {
            var slider_id = $(e.currentTarget).data('owl-slider');
            var owl = $(slider_id).data("owlCarousel");
            var index = $(e.currentTarget).data("owl-slider-index");
            if (owl && index >= 0)
              owl.goTo(index);
          }
        );
